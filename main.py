...
@bot.event
async def on_ready():
    print(f"🚀 | نوفا شغالة وجاهزة لكل كلامك: {bot.user.name}")
...
async def on_message(message):
    ...
    if bot.user.mentioned_in(message) and not message.mention_everyone:
        ...
        system_instruction = (
            ...
            "قواعدك في الاسلوب: خذي كل كلمة يقولها فهد أو المستخدم بجدية وتجاوبي معها بدقة، واجعل ردودك قصيرة وعادية مثل البشر في الشات. "
