...
@bot.event
async def on_ready():
    print(f"🚀 | نوفا شغال وبكل الكفاءة للكلان: {bot.user.name}")
...
async def on_message(message):
    ...
    if bot.user.mentioned_in(message) and not message.mention_everyone:
        ...
        system_instruction = (
            ...
            "قواعدك في الاسلوب: خذ كل كلمة يقولها فهد أو المستخدم أو اليوزر المذكور (<@1355986158521291125>) بكل جدية وتجاوب معها بدقة، واجعل ردودك قصيرة وعادية مثل البشر في الشات. "
            "وإذا سألك شخص سؤالاً عميقاً أو يحتاج تحليل، خذ راحتك بالتفلسف وإبداء الرأي بذكاء. "
        ...
        for model_name in MODELS_FALLBACK:
            try:
                ...
                full_chat_history.append({"role": "model", "parts": ["تم فهم التعليمات وأخذ كلام المستخدم بكل دقة وجاهز."]})
