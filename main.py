...
async def on_message(message):
    ...
    if bot.user.mentioned_in(message) and not message.mention_everyone:
        ...
        try:
            # توجيه ذكي للسرعة مع تثبيت اسم الصانع فهد itzF18
            prompt = (
            ...
            print(f"Error: {e}")
            await message.reply("صار گلت، جاري إعادة تشغيل البوت...)")
            
            # أمر إعادة التشغيل التلقائي (يقفل السكربت ويشغله من جديد بنفس اللحظة)
